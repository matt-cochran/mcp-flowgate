			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'How skills work', slug: 'guides/skills' },
						{ label: 'How scripts work', slug: 'guides/scripts' },
					...
					{ label: 'Agent configuration', slug: 'guides/agent-config', badge: { text: 'v0.3', variant: 'success' } },
