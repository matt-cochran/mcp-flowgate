---
title: "Quick start"
description: "Create a minimal config, wire mcp-flowgate into your MCP host, and see the ten tools in action — all in about 30 seconds."
---

You're going to create one capability, connect it to your MCP host, and watch the model discover and call it through mcp-flowgate's ten tools. The whole thing takes about 30 seconds.
...
Restart Claude Desktop (or Zed). Ten tools appear in the model's tool list:
...
That's it. Ten tools, always. Whether you have one capability or five hundred behind them.
