...
| Tool | What it does |
|------|-------------|
| `gateway.home` | Returns the full catalog of capabilities and workflows |
| `gateway.search` | Takes a query string, returns scored matches |
| `gateway.describe` | Returns the full schema for a specific capability or workflow |
