...
- **`name`** — the repo's identifier, lowercase kebab. Used in diagnostics and `gateway.describe`.
...
- **`version`** — repo version, semver-shaped by convention. Surfaced via `gateway.describe`.
