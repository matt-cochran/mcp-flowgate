...
Three connection kinds, three executor kinds, all wired through the same ten tools. The model searches for "deploy" or "notify slack" through `gateway.search` and follows links from there.
