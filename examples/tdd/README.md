...
A real example of using mcp-flowgate to enforce red → green → refactor
...
```bash
# 1. Validate
mcp-flowgate check --config examples/tdd/gateway.yaml
...
# 3. Serve
mcp-flowgate serve --config examples/tdd/gateway.yaml
```
...
- [`docs/GOVERNANCE.md`](../../docs/GOVERNANCE.md) — guards, branches
