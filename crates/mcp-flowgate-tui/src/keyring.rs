...
//! `flowgate acp` and started waiting.
//!
...
//! ## Reference
//!
//! Lifted from `frontrails-product/crates/frontrails-agent-cli/src/main.rs`
//! (read-only reference). The flowgate copy adapts error messages to use
//! `flowgate` branding and slightly tightens the spawn-error fallback
//! commentary.
