...
//!
//! Asserts that `mcp_flowgate_executors::REGISTERED_EXECUTOR_KINDS`
...
//!   - `REGISTERED_EXECUTOR_KINDS` in `crates/mcp-flowgate-executors/src/lib.rs`
...
use mcp_flowgate_executors::REGISTERED_EXECUTOR_KINDS;
