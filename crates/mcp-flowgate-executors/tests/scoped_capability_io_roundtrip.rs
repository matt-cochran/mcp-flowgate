...
//! `mcp-flowgate-core::tests::walk_examples`. We host it here in the
//! `mcp-flowgate-executors` crate instead because the test requires
...
//!
//! **What it asserts.** A host orchestrator invokes a capability via
...
"#;
    ...
    // Start the host orchestrator. With NO non-deterministic links and
