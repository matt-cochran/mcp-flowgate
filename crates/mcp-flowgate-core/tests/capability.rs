...
use mcp_flowgate_core::capability::{Capability, CapabilityRegistry, CapabilitySource};
use mcp_flowgate_core::proxy_workflow::compile_proxy_workflow_from_registry;
use serde_json::json;
